<script setup>
// Custom inline SVG icon set (stroke = currentColor), themed for Manibandha.
defineProps({
...
<template>
  <svg :width="size" :height="size" viewBox="0 0 24 24" fill="none" stroke="currentColor"
    ...
    <!-- Ученики (person) -->
    <template v-else-if="name === 'disciples'">
      <circle cx="12" cy="8" r="3.3" />
      <path d="M5.5 19.5c0-3.6 2.9-6.2 6.5-6.2s6.5 2.6 6.5 6.2" />
    </template>

    <!-- Пользователи (two people) -->
    <template v-else-if="name === 'users'">
      <circle cx="9" cy="8" r="3" />
      <path d="M3.5 19c0-3 2.4-5.2 5.5-5.2S14.5 16 14.5 19" />
      <path d="M15.5 5.6a3 3 0 0 1 0 5.6" />
      <path d="M17 13.9c2 .5 3.5 2.3 3.5 4.8" />
    </template>

    <!-- Храмы / Паломничества (mandir) -->
    <template v-else-if="name === 'temple'">
      <path d="M12 2.5 8.5 7h7L12 2.5Z" />
      <path d="M8.5 7v3h7V7" />
    ...
    <template v-else-if="name === 'book'">
      <path d="M12 6.6C10.4 5.4 8.4 4.8 6 4.8c-.8 0-1.5.6-1.5 1.4v10.4c0 .8.7 1.3 1.5 1.3 2.4 0 4.4.6 6 1.8" />
      <path d="M12 6.6c1.6-1.2 3.6-1.8 6-1.8.8 0 1.5.6 1.5 1.4v10.4c0 .8-.7 1.3-1.5 1.3-2.4 0-4.4.6-6 1.8" />
      <path d="M12 6.6V19.7" />
    </template>
    ...
    <template v-else-if="name === 'settings'">
      <g transform="translate(12 12) scale(0.9) translate(-12 -12)">
        ...
        <path vector-effect="non-scaling-stroke" d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z" />
      </g>
    </template>
    ...
    <!-- filled lotus (logo badge) -->
    <template v-else-if="name === 'lotus-solid'">
      <g fill="currentColor" stroke="none">
        <path d="M12 2.8c1.5 2.2 2.2 4.3 2.2 6.2 0 2.1-.7 4-2.2 5.6-1.5-1.6-2.2-3.5-2.2-5.6 0-1.9.7-4 2.2-6.2Z" />
        <path d="M11.4 14.6C9.9 12 7.7 10.4 5 10c-.2 2.6 1.1 4.8 3.7 6 1 .5 2 .3 2.7-1.4Z" />
        <path d="M12.6 14.6C14.1 12 16.3 10.4 19 10c.2 2.6-1.1 4.8-3.7 6-1 .5-2 .3-2.7-1.4Z" />
        <path d="M12 16.9c-3 0-5.9-1.2-7.9-3.3.3 2.5 1.8 4.5 4.1 5.3 1.9.7 5.7.7 7.6 0 2.3-.8 3.8-2.8 4.1-5.3-2 2.1-4.9 3.3-7.9 3.3Z" />
      </g>
    </template>
    ...
    <template v-else-if="name === 'forum'">
      <g transform="translate(12 12) scale(1.2) translate(-9.5 -11)">
        <path vector-effect="non-scaling-stroke" d="M4 5.5h11a1.5 1.5 0 0 1 1.5 1.5v5A1.5 1.5 0 0 1 15 13.5H8l-3 3v-3H4A1.5 1.5 0 0 1 2.5 12V7A1.5 1.5 0 0 1 4 5.5Z" />
        <path vector-effect="non-scaling-stroke" d="M8 9.5h5" />
      </g>
    </template>

    <!-- key / ключ (роли, доступ) -->
    <template v-else-if="name === 'key'">
      <circle cx="7.5" cy="16.5" r="3.5" />
      <path d="M10 14 20 4" />
      <path d="M16.5 7.5 19.5 10.5" />
    ...
    <!-- phone (телефон) — по центру viewBox, как в Telegram -->
    <template v-else-if="name === 'phone'">
      <path d="M21 16.5v2.6a1.9 1.9 0 0 1-2.1 1.9 18.8 18.8 0 0 1-8.2-2.9 18.5 18.5 0 0 1-5.7-5.7A18.8 18.8 0 0 1 2.1 4.1 1.9 1.9 0 0 1 4 2h2.6a1.9 1.9 0 0 1 1.9 1.6c.1.9.3 1.7.6 2.5a1.9 1.9 0 0 1-.4 2L7.5 9.3a15 15 0 0 0 5.7 5.7l1.2-1.2a1.9 1.9 0 0 1 2-.4c.8.3 1.6.5 2.5.6A1.9 1.9 0 0 1 21 16.5z" />
    </template>
    ...
    <template v-else-if="name === 'lotus'">
      ...
      <path d="M9.4 8.6C8 7.5 6 7 3.8 7.2c-.2 2.1.5 4.1 2 5.4" />
      <path d="M14.6 8.6c1.4-1.1 3.4-1.6 5.6-1.4.2 2.1-.5 4.1-2 5.4" />
      <path d="M4 12.3c1.5 2.7 4.6 4.4 8 4.4s6.5-1.7 8-4.4" />
    </template>
  </svg>
</template>
