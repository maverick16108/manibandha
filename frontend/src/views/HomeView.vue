...
<template>
  <div class="min-h-screen bg-parchment-100 text-ink-800">
    ...
    <section class="relative min-h-[100svh] overflow-hidden">
      ...
      <img :src="hero" alt="Манибандха Прабху" :class="galleryBw && 'grayscale'" class="photo-bw absolute inset-0 h-full w-full object-cover object-[40%_15%] sm:object-[52%_14%] min-[2000px]:object-[52%_12%]" />
