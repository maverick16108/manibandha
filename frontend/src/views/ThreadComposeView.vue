  ...
  <div class="mx-auto max-w-6xl">
    <form class="card space-y-4 p-6" @submit.prevent="submit">
      ...
      <div>
        ...
        <MarkdownEditor v-model="form.body" :rows="6" height-class="min-h-[40vh]" type-anywhere :draft-scope="`new:${kind}`" placeholder="Текст… (можно вставлять фото)" @submit="submit" />
      </div>
